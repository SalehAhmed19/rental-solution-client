...
const locations = [
  {
    name: "মিরপুর",
    properties: "৪৫০+ বাসা",
    // Modern Building/Apartment in City context
  ...
  },
  {
    name: "ধানমন্ডি",
    properties: "২০০+ বাসা",
    // Lakeside or upscale residential
    ...
    <section className="relative py-24 overflow-hidden bg-white">
      ...
      <div className="px-6 mx-auto max-w-7xl md:px-12">
        ...
        >
          ...
          {/* কাস্টম নেভিগেশন বাটন - নিচে সাজানো */}
