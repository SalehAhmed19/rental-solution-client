...
const faqs = [
  {
    question: "নব ঠিকানা প্ল্যাটফর্মে বাসা খোঁজা কি নিরাপদ?",
    answer:
      "জি, অবশ্যই। আমরা প্রতিটি লিস্টিং ম্যানুয়ালি ভেরিফাই করি এবং মালিকের এনআইডি (NID) যাচাই করার চেষ্টা করি। আমাদের প্ল্যাটফর্মে কোনো ফেক বা ভুয়া লিস্টিং अ্যালাউ करা हय ना।",
  },
  {
    question: "বাসা ভাড়ার ক্ষেত্রে কোনো ব্রোকার ফি দিতে হবে?",
    answer:
      "না, নব ঠিকানা একটি সরাসরি ভাড়াটিয়া-মালিক সংযোগ মাধ্যম। এখানে কোনো ব্রোকার বা মিডিয়া ফি নেই। আপনি সরাসরি মালিকের সাথে কথা বলে বাসা ভাড়া নিতে পারবেন।",
  },
  {
